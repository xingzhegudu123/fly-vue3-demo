<template>
  <div id="detialContainer" class="slide-enter-active">
    <Header titie="影片详情">
    ...
    <div v-else id="content" class="contentDetail">
      <div class="detail_list">
        ...
        <div class="detail_list_content">
          ...
          <!-- :style ="{ 'background-image':url('+ detailMovie.img +')}" -->
      ...
      if (msg === "ok") {
        ...
        this.$nextTick(() => {
          new Swiper(this.$refs.detail_player, {
            slidesPerView: "auto",
            freeMode: true,
            freeModeSticky: ".swiper-pagination"
          });
        });
      }
    });
...
/* 动画 */
#detialContainer.slide-enter-active {
